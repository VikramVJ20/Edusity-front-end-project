  ...
  return (
    <div className='about'>
        ...
        <div className="about-right">
            ...
            <p>Embrak on a transformative educational journey with our university's comprehensive education programs. Our cutting-edge curriculm is designed to empower students with the knowledge, skills, and experieces needed to excel in the dynamic field of education.</p>
